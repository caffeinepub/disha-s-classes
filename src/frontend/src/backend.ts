...
export class Backend implements backendInterface {
    ...
    async getStudentByNameAndPhone(arg0: string, arg1: string): Promise<Student | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getStudentByNameAndPhone(arg0, arg1);
    ...
    async getStudentsByCourse(arg0: string): Promise<Array<Student>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStudentsByCourse(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markAttendance(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateStudentNotes(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateStudentNotes(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
